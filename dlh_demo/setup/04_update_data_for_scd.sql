...
VALUES (1022, 2, DATE '2024-01-07', 45.00, 'Books', 'Completed');

-- Order 1024: New version - Pending -> Shipped
INSERT INTO nessie.raw.orders_iceberg 
(order_id, customer_id, order_date, amount, product_category, order_status)
VALUES (1024, 4, DATE '2024-01-07', 399.99, 'Electronics', 'Shipped');

-- Order 1005: New version - Price adjustment
INSERT INTO nessie.raw.orders_iceberg 
(order_id, customer_id, order_date, amount, product_category, order_status)
VALUES (1005, 5, DATE '2024-01-07', 275.00, 'Home & Garden', 'Completed');

-- Order 1001: New version - Status change
INSERT INTO nessie.raw.orders_iceberg 
(order_id, customer_id, order_date, amount, product_category, order_status)
VALUES (1001, 1, DATE '2024-01-07', 150.00, 'Electronics', 'Delivered');

-- Order 1008: New version - Amount correction
INSERT INTO nessie.raw.orders_iceberg 
(order_id, customer_id, order_date, amount, product_category, order_status)
VALUES (1008, 8, DATE '2024-01-07', 95.00, 'Books', 'Completed');

-- Order 1015: New version - Status update
INSERT INTO nessie.raw.orders_iceberg 
(order_id, customer_id, order_date, amount, product_category, order_status)
VALUES (1015, 5, DATE '2024-01-07', 180.00, 'Electronics', 'Returned');
...
VALUES (2, 'Bob Smith', 'bob.smith@email.com', 'Canada', DATE '2024-01-07', 'Premium');

-- Customer 5: New version - Email update
INSERT INTO nessie.raw.customers_iceberg 
(customer_id, name, email, country, signup_date, customer_segment)
VALUES (5, 'Eve Wilson', 'eve.wilson.updated@email.com', 'Australia', DATE '2024-01-07', 'Regular');

-- Customer 8: New version - Country change
INSERT INTO nessie.raw.customers_iceberg 
(customer_id, name, email, country, signup_date, customer_segment)
VALUES (8, 'Helen Taylor', 'helen.taylor@email.com', 'Canada', DATE '2024-01-07', 'Premium');

-- Customer 1: New version - Segment downgrade
INSERT INTO nessie.raw.customers_iceberg 
(customer_id, name, email, country, signup_date, customer_segment)
VALUES (1, 'Alice Johnson', 'alice.johnson@email.com', 'USA', DATE '2024-01-07', 'Regular');

-- Customer 4: New version - Name change
INSERT INTO nessie.raw.customers_iceberg 
(customer_id, name, email, country, signup_date, customer_segment)
VALUES (4, 'David Brown Jr.', 'david.brown@email.com', 'UK', DATE '2024-01-07', 'Premium');

-- Customer 10: New version - Email and country update
INSERT INTO nessie.raw.customers_iceberg 
(customer_id, name, email, country, signup_date, customer_segment)
VALUES (10, 'Jack Anderson', 'jack.anderson.new@email.com', 'Germany', DATE '2024-01-07', 'VIP');
